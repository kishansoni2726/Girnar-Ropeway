...
<?php
try{
      $con=new PDO("mysql:host=localhost;dbname=gir_ropeway","root","");
...
$ts=$_POST['timeslot'];
	$em=$_POST['em'];
		$insert=$con->prepare("UPDATE booking SET timeslot=:timeslot  WHERE email = :email");
		$insert->bindparam(':email',$em);
		$insert->bindparam(':timeslot',$ts);
		$insert->execute();
    ...
    <div class="col l12 s12 m6">
      <div class="card ">
        <div class="card-content wblack-text">
      ...
      <table>
        ...
        <div class="card-content">
         <p class="right-align">Need Help? visit our <a href="contact.php"> help center</a></p>
        </div>
